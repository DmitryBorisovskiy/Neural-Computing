...
norm_wine_tain = table(norm_type, norm_fixedacidity, norm_volatileacidity, norm_citricAcid, norm_residualSugar, norm_chlorides, norm_totalSulfurDioxide, norm_density, norm_pH, norm_sulphates, norm_alcohol,wine_train.QualityGroup);
...
predictors = norm_wine_tain(:, predictorNames);
response = norm_wine_tain.Var12;
